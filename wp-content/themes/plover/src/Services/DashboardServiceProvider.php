...
class DashboardServiceProvider extends ServiceProvider {
	...
	public function add_theme_admin_menu() {
		...
		add_theme_page(
			...
			'edit_theme_options',
			'plover-tutorials',
			[ $this, 'show_theme_tutorials_page' ]
		);
	...
	public function show_theme_admin_page() {
		...
		$modules = apply_filters( 'plover_theme_dashboard_plugin_module', [
			...
			[
				...
				'description' => __( 'Add responsive flexbox, text alignment, display, sizing, and positioning controls to core blocks. Create flexible, responsive layouts with ease.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/advanced-layout/',
				'icon'        => plover_theme()->core_url( 'assets/images/advanced-layout.png' ),
			],
			[
			...
			[
				'label'       => __( 'Breadcrumb', 'plover' ),
				'description' => __( 'Let’s you easily display breadcrumb navigation on your WordPress site, easy customization.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/breadcrumb/',
				'icon'        => plover_asset_url( 'images/breadcrumb.png' ),
			],
			[
				'label'       => __( 'Reading Time Block', 'plover' ),
				'description' => __( 'Let’s you easily add an estimated reading time to your WordPress posts.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/reading-time-block/',
				'icon'        => plover_asset_url( 'images/reading-time-block.png' ),
			],
			[
				'label'       => __( 'Magazine Layout', 'plover' ),
				'description' => __( 'Elevate your WordPress site with the Magazine Layout dynamic content presentation.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/magazine-layout/',
				'icon'        => plover_theme()->core_url( 'assets/images/magazine-layout.png' ),
			],
			[
				'label'       => __( 'Typing Animation', 'plover' ),
				'description' => __( 'Add dynamic typing effects to your text.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/typing-animation/',
				'icon'        => plover_asset_url( 'images/typing-animation.png' ),
			],
			[
				'label'       => __( 'Rough Notation', 'plover' ),
				'description' => __( 'Create and animate hand-draw style notations on a page.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/rough-notation/',
				'icon'        => plover_theme()->core_url( 'assets/images/rough-notation.png' ),
			],
			[
				'label'       => __( 'Preloader', 'plover' ),
				'description' => __( 'Animated elements that appear while website content loads make waiting more enjoyable.', 'plover' ),
				'doc'         => 'https://wpplover.com/docs/plover-kit/modules/preloader/',
				'icon'        => plover_asset_url( 'images/preloader.png' ),
			],
			[
			...
			[
				...
				'icon'        => plover_theme()->core_url( 'assets/images/block-event-handler.png' ),
			],
			[
		...
		$widgets = apply_filters( 'plover_theme_dashboard_widgets', [
			...
			[
				...
				'content' => __( 'Take your site building to the next level with Premium. Unlock advanced modules and professional features that give you complete creative freedom — all while keeping your site fast with our modular design.', 'plover' ),
				...
				'actions' => [
					...
					[
						'url'    => 'https://wpplover.com/plugins/plover-kit/#free-vs-premium',
						'target' => '_blank',
						'label'  => __( 'Free vs Premium', 'plover' ),
						'style'  => 'ghost',
					],
				],
			],
			[
				'title'   => __( "Beginner's Tutorials", 'plover' ),
				'content' => __( "New to Full Site Editing and the Plover theme? No worries — we've prepared a series of tutorials to help you get started quickly.", 'plover' ),
				'enable'  => true,
				'actions' => [
					[
						'url'   => admin_url( 'themes.php?page=plover-tutorials' ),
						'label' => __( 'View Tutorials', 'plover' ),
						'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><g><path d="M50 87.372c-.288 0-.575-.061-.844-.185-14.383-6.604-29.336-9.266-44.454-7.908a2.051 2.051 0 0 1-1.545-.521 2.024 2.024 0 0 1-.657-1.493v-56.95a2.021 2.021 0 0 1 4.043 0v54.766c14.78-.965 29.381 1.74 43.457 8.05 14.075-6.31 28.678-9.017 43.457-8.05V20.315a2.021 2.021 0 0 1 4.043 0v56.95c0 .568-.239 1.11-.657 1.493a2.038 2.038 0 0 1-1.545.52c-15.119-1.358-30.071 1.304-44.454 7.91a2.017 2.017 0 0 1-.844.184z"></path><path d="M47.473 18.417V73.03c-10.995-4.618-22.517-6.599-34.624-5.508V12.92c12.107-1.082 23.629.879 34.624 5.498zM87.151 12.919v54.604c-12.107-1.091-23.629.89-34.624 5.508V18.417c10.995-4.62 22.517-6.58 34.624-5.498z"></path></g></svg>',
					],
				]
			],
			[
			...
			[
				'title'   => __( 'Get Expert WordPress Help', 'plover' ),
				'content' => __( "Facing a bug or need a custom feature? Our WordPress experts are available to help with fixes, custom development, and optimization.", 'plover' ),
				'enable'  => true,
				'actions' => [
					[
						'url'    => 'https://wpplover.com/expert/',
						'label'  => __( 'Get a Quote', 'plover' ),
						'target' => '_blank',
						'icon'   => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.941 31.941"><g><path d="m5.963 22.063-2.211 6.265a1.031 1.031 0 0 0 1.299 1.321l3.278-1.094 1.867 2.911a1.03 1.03 0 0 0 1.84-.213l2.247-6.369-2.803-2.439-5.517-.382zM25.982 22.063l-5.517.381-2.803 2.442 2.246 6.365a1.029 1.029 0 0 0 1.839.215l1.864-2.911 3.279 1.094c.373.125.784.026 1.062-.255.274-.281.366-.695.235-1.066l-2.205-6.265zM22.875 20.392a2.045 2.045 0 0 0 1.896-1.896l.219-3.167 2.082-2.393a2.038 2.038 0 0 0 .002-2.68L24.99 7.862l-.219-3.165a2.04 2.04 0 0 0-1.896-1.895l-3.166-.219L17.314.501a2.04 2.04 0 0 0-2.68.001l-2.393 2.083-3.166.218a2.039 2.039 0 0 0-1.894 1.895l-.22 3.166-2.083 2.394a2.041 2.041 0 0 0 0 2.679l2.083 2.393.219 3.167a2.042 2.042 0 0 0 1.895 1.894l3.169.22 2.393 2.083a2.039 2.039 0 0 0 2.679 0l2.393-2.083 3.166-.219zm-3.967-6.562.23 2.104c.043.395-.218.584-.576.421l-1.931-.873c-.362-.163-.954-.163-1.316 0l-1.928.873c-.362.163-.623-.026-.577-.421l.231-2.104c.046-.394-.138-.959-.405-1.252l-1.427-1.565c-.267-.292-.167-.599.221-.68l2.074-.428c.389-.08.869-.428 1.065-.773l1.047-1.839c.196-.346.517-.346.712 0l1.049 1.839c.194.346.677.694 1.063.773l2.074.428c.389.081.486.387.221.68l-1.426 1.565c-.265.293-.448.857-.401 1.252z" fill="currentColor"></path></g></svg>',
					],
				]
			],
		] );
                                ...
                                <div class="dashboard-widget">
                                    ...
                                    <div class="widget-actions">
										<?php foreach ( $widget['actions'] as $action ): ?>
                                            <a class="widget-link plover-admin-button is-style-<?php echo esc_attr( $action['style'] ?? 'primary' ) ?>"
                                               href="<?php echo esc_url( $action['url'] ) ?>"
                                               target="<?php echo esc_attr( $action['target'] ?? '_self' ) ?>">
												<?php echo isset( $action['icon'] ) ? wp_kses_post( $action['icon'] ) : ''; ?>
	 ...
	 * @return void
	 */
	public function show_theme_tutorials_page() {
		$categories = apply_filters( 'plover_theme_dashboard_tutorials', [
			'site-editor'           => [
				'title'     => __( 'Site Editor Tutorials', 'plover' ),
				'tutorials' => [
					[
						'title'   => __( 'Welcome to Plover Theme!', 'plover' ),
						'excerpt' => __( 'Welcome to the Plover Theme! This article provides a comprehensive overview of its powerful features, giving you everything you need to start building your dream WordPress site.', 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/getting-started/welcome-to-plover-theme/',
					],
					[
						'title'   => __( 'What is Full Site Editing (FSE)?', 'plover' ),
						'excerpt' => __( "This article introduces Full Site Editing (FSE) in plain language, compares it to classic theming, and explains core concepts like blocks, templates, and global styles to help you start building with the Plover Theme.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/getting-started/what-is-full-site-editing/',
					],
					[
						'title'   => __( 'Site Editor Overview', 'plover' ),
						'excerpt' => __( "Welcome to the Site Editor—the heart of Full Site Editing in WordPress. This article walks you through each part of the interface, explains what everything does, and helps you feel confident designing your entire site with Plover Theme.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/getting-started/site-editor-overview/',
					],
					[
						'title'   => __( 'Navigation sidebar', 'plover' ),
						'excerpt' => __( "This article introduces the Navigation Sidebar, your command center in the WordPress Site Editor. Learn to use it to preview content, manage styles, templates, and patterns, and create new templates for your Plover site.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/getting-started/navigation-sidebar/',
					],
					[
						'title'   => __( 'Site Editor Area', 'plover' ),
						'excerpt' => __( "This article walks you through the WordPress Site Editor interface. Master the Styles sidebar — where you can customize global styles, individual blocks, and even add custom CSS for your Plover site.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/getting-started/editor-area/',
					],
				]
			],
			'dark-mode'             => [
				'title'     => __( 'Dark Mode Tutorials', 'plover' ),
				'tutorials' => [
					[
						'title'   => __( 'Dark Mode Quick Start', 'plover' ),
						'excerpt' => __( "This quick start guide shows you how to enable dark mode in Plover Theme. You'll learn to add the toggle button using a preset pattern and preview dark mode directly in the Site Editor.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/quick-start/',
					],
					[
						'title'   => __( 'Block Level Dark Mode', 'plover' ),
						'excerpt' => __( "This article explains block-level dark mode in Plover Theme. Learn how to force specific container blocks—like Group, Row, and Columns — to always stay in dark or light mode, independent of your global settings.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/block-level-dark-mode/',
					],
					[
						'title'   => __( 'Fine-tuning Dark Mode Colors', 'plover' ),
						'excerpt' => __( "Discover how to fine-tune dark mode colors in Plover Theme. Learn the exact color inversion rules for light and dark modes, and explore how to manage and customize the color palette directly in the Site Editor.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/fine-tuning-dark-mode-colors/',
					],
					[
						'title'   => __( 'Show or hide blocks based on color mode', 'plover' ),
						'excerpt' => __( "Learn to control block visibility based on your site's color mode in Plover Theme. This feature lets you show or hide specific blocks in light or dark mode—perfect for using different images or content optimized for each theme.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/show-or-hide-blocks-based-on-color-mode/',
					],
					[
						'title'   => __( 'Global dark mode settings', 'plover' ),
						'excerpt' => __( "Ready to take control of dark mode across your entire site? This guide covers the global dark mode settings available through the Plover Kit plugin. You'll learn how to set the default color mode for new visitors and configure the cookie period to remember their preferences.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/global-dark-mode-settings/',
					],
					[
						'title'   => __( 'Advanced: Create your own toggle button', 'plover' ),
						'excerpt' => __( "Ready to build a custom dark mode toggle? This guide walks you through creating your own button using the Block Event Handler and visibility settings, with the exact code you'll need to make it work.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/dark-mode/create-your-own-toggle-button/',
					],
				]
			],
			'resources-and-support' => [
				'title'     => __( 'Resources and Support', 'plover' ),
				'tutorials' => [
					[
						'title'   => __( 'Resources and Support', 'plover' ),
						'excerpt' => __( "Looking for help with Plover Theme? This resource guide covers frequently asked questions about general setup, dark mode, customization, and the Plover Kit plugin — plus how to reach official support through forums or email.", 'plover' ),
						'url'     => 'https://wpplover.com/docs/plover-theme/resources-and-support/',
					],
					[
						'title'   => __( 'Get Expert WordPress Help', 'plover' ),
						'excerpt' => __( "Facing a bug or need a custom feature? Our WordPress experts are available to help with fixes, custom development, and optimization.", 'plover' ),
						'url'     => 'https://wpplover.com/expert/',
						'label'   => __( 'Get a Quote', 'plover' )
					],
				]
        ...
        <div class="plover-dashboard-wrap wrap plover-admin-page">
            <div class="plover-dashboard-body">
				<?php foreach ( $categories as $category ): ?>
                    ...
                    <div class="plover-dashboard-tutorial-list">
						<?php foreach ( $category['tutorials'] as $tutorial ): ?>
                            <div class="plover-dashboard-tutorial plover-dashboard-tutorial-card">
                                <div class="plover-dashboard-module-header">
                                    <img src="<?php the_plover_asset_url( 'images/tutorial-background.png' ); ?>"
                                         alt="tutorial-background"/>
                                    <div class="plover-dashboard-module-title">
                                        <h3><?php echo esc_html( $tutorial['title'] ) ?></h3>
                                    </div>
                                </div>
                                <div class="plover-dashboard-module-content">
                                    <p><?php echo esc_html( $tutorial['excerpt'] ) ?></p>
                                    <a class="tutorial-link plover-admin-button is-style-ghost"
                                       href="<?php echo esc_url( $tutorial['url'] ) ?>"
                                       target="_blank">
                                        <span><?php echo esc_html( isset( $tutorial['label'] ) ? $tutorial['label'] : __( 'View Tutorial', 'plover' ) ); ?></span>
                                    </a>
                                </div>
                            </div>
						<?php endforeach; ?>
