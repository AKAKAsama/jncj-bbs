...
<div class="wp-block-group alignwide is-style-dark has-neutral-950-color has-neutral-0-background-color has-text-color has-background has-link-color"
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group">
            <!-- wp:navigation {"icon":"menu","overlayBackgroundColor":"neutral-0","overlayTextColor":"neutral-950","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal"},"style":{"spacing":{"margin":{"top":"0"},"blockGap":"var:preset|spacing|x-small"},"layout":{"selfStretch":"fit","flexSize":null}},"ploverBlockID":"ad0abaa2-852c-48de-af64-0ec82ddee6b6","cssOrder":{"desktop":"","tablet":1,"mobile":"__INITIAL_VALUE__"}} /-->
