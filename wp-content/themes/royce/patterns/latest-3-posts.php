 ...
 * Slug: royce/latest-3-posts
 * Categories: query, royce
 * Block Types: core/query
 */
?>
<!-- wp:group {"metadata":{"name":"Royce: Latest 3 posts"},"ploverBlockID":"9ad9b53e-84d5-4692-abf6-d49b9548403c","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|2-x-large","bottom":"var:preset|spacing|2-x-large"},"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|neutral-950"}}}},"backgroundColor":"neutral-0","textColor":"neutral-950","layout":{"type":"constrained","justifyContent":"center"}} -->
<div class="wp-block-group alignfull has-neutral-950-color has-neutral-0-background-color has-text-color has-background has-link-color"
    ...
    <!-- wp:group {"metadata":{"name":"Section Heading"},"ploverBlockID":"3948042d-b9b6-46e1-bcf2-79cbd1dd4006","align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small"},"blockGap":"var:preset|spacing|x-small"},"background":{"backgroundImage":{"url":"<?php royce_the_asset_url( 'images/heading-news.png' ) ?>","source":"file","title":"heading-news"},"backgroundSize":"contain","backgroundRepeat":"no-repeat","backgroundPosition":"50% 17%"}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small)"><!-- wp:heading {"textAlign":"center","ploverBlockID":"3d355a3b-154e-4f06-9582-0855755e713c","entranceAnimation":"fadeInUp"} -->
    <h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Latest Posts', 'royce' ) ?></h2>
    <!-- /wp:heading --></div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-query alignwide">
        ...
        <p class="has-text-align-center"
           style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
			<?php esc_html_e( 'No posts were found.', 'royce' ); ?>
        </p>
        <!-- /wp:paragraph -->
        <!-- /wp:query-no-results -->
