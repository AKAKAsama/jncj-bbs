...
class BBP_Forums_Component extends BP_Component {
	...
	public function __construct() {
		parent::start(
			'forums',
			function_exists('esc_html__') && did_action('init') ? esc_html__( 'Forums', 'bbpress' ) : 'Forums',
	...
	public function setup_globals( $args = array() ) {
		...
		$args = array(
			...
			'has_directory' => false,
			'search_string' => did_action('init') ? esc_html__( 'Search Forums...', 'bbpress' ) : 'Search Forums...',
		);
